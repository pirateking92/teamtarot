...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-D73FZ3qm.js')),
			__memo(() => import('./chunks/1-BUEW2wcK.js')),
			__memo(() => import('./chunks/2-BsNhZ1aW.js')),
			__memo(() => import('./chunks/3-BSP2Q7fx.js')),
			__memo(() => import('./chunks/4-BdegcCXP.js'))
		],
		routes: [
			{
				id: "/",
