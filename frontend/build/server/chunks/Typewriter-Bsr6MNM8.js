import { c as create_ssr_component, i as is_promise, n as noop } from './ssr-tGUPulqZ.js';
...
const Typewriter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const modes = {
    concurrent: () => import('./concurrent-Bleo_gEm.js'),
    cascade: () => import('./cascade-CkOnev1M.js'),
    loop: () => import('./loop-N_SdXHTJ.js'),
    loopOnce: () => import('./loopOnce-CLbDapGF.js'),
    loopRandom: () => import('./loopRandom-B-PBfvyH.js'),
    scramble: () => import('./scramble-Cv7KEq60.js')
  };
...
export { Typewriter as T };
//# sourceMappingURL=Typewriter-Bsr6MNM8.js.map
